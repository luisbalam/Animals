 ...
 */
public class AnimalsLoader extends AsyncTaskLoader<Cursor> {
    ...
    public AnimalsLoader(@NonNull Context context) {
        super(context);
    }
    ...
    public Cursor loadInBackground() {
        ...
        Cursor cursor = AnimalsDatabase.devuelveTodos(context);
    ...
    protected void onStartLoading() {
        ...
        if (mObserver == null) {
            mObserver = new AnimalsObserver(this);
            mObserver.register();
        }
    ...
    public static class AnimalsObserver extends BroadcastReceiver {
        private final AnimalsLoader loader;

        public AnimalsObserver(AnimalsLoader loader) {
            this.loader = loader;
        }
